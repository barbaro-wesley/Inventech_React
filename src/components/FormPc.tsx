...
export function FormPc({ isOpen, onClose, onSubmit, initialData = null }: EquipamentoFormProps) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6 mt-4 sm:mt-6">
          ...
          <Card className="p-4 sm:p-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              ...
              <div>
                <Label htmlFor="ip" className="text-sm sm:text-base">Endereço IP</Label>
                <Input
                  id="ip"
                  value={formData.ip}
              ...
              <div>
                <Label htmlFor="sistemaOperacional" className="text-sm sm:text-base">Sistema Operacional</Label>
                <Input
